...
module.exports = tasks.Tasks.fromObject({
    ...
    { //30
        text: [
            'Задан вещественный массив $v$ произвольной длины $n$. Локальным максимумом массива назовем такой элемент $v[i]$, для которого верно $v[i-1]\\le v[i]\\le v[i+1]$. В этом случае $i$ &mdash; индекс максимума. Найти индексы двух наиболее удаленных смежных максимумов. Смежные максимумы &mdash; те, между которыми нет  других максимумов.',
